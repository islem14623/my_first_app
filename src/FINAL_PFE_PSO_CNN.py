"""
PSO + CNN Pipeline - Final PFE Version (UPDATED)
...
# Import PSO functions (load_data only - PSO algorithm skipped)
...
def main():
    ...
    # STEP 4: Load pre-computed PSO feature selection results
    print("\n[STEP 4] Loading pre-computed PSO feature selection results...")
    print("(Reusing FS results - no need to re-run PSO algorithm)")
    ...
    print(f"✓ Loaded {len(selected_indices)} pre-selected features from PSO")
    print(f"✓ Skipping PSO algorithm - saves ~70 minutes!")
    ...
    plot_training_history(
        history,
        save_path="pso_cnn_training_history.png",
        model_name="PSO + CNN"
    )
    ...
    with open("pso_final_metrics.json", "w") as f:
    ...
    print("✓ Metrics saved as 'pso_final_metrics.json'")
    print("✓ Training history plot saved as 'pso_cnn_training_history.png'")
