"""
GA + LSTM Pipeline - Final PFE Version
...
def main():
    ...
    print("="*90)
    print("FINAL PFE PIPELINE: GENETIC ALGORITHM + LSTM")
    print("="*90)
    ...
    plot_training_history(history, "ga_lstm_training_history.png")
    ...
    model.save("final_ga_lstm_model.keras")
    joblib.dump(scaler, "ga_lstm_scaler.pkl")
    joblib.dump(selected_indices, "ga_lstm_selected_features.pkl")

    selected_feature_names = [feature_names[i] for i in selected_indices]
    with open("ga_lstm_selected_feature_names.txt", "w") as f:
    ...
    with open("ga_lstm_final_metrics.json", "w") as f:
        json.dump(final_metrics, f, indent=2)

    print("✓ Model saved as 'final_ga_lstm_model.keras'")
    print("✓ Scaler saved as 'ga_lstm_scaler.pkl'")
    print("✓ Selected features saved as 'ga_lstm_selected_features.pkl'")
    print("✓ Feature names saved as 'ga_lstm_selected_feature_names.txt'")
    print("✓ Metrics saved as 'ga_lstm_final_metrics.json'")
    print("✓ Training history plot saved as 'ga_lstm_training_history.png'")
