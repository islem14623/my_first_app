"""
ACO + LSTM Pipeline - Final PFE Version
...
def main():
    ...
    print("="*90)
    print("FINAL PFE PIPELINE: ACO FEATURE SELECTION + LSTM")
    print("="*90)
    ...
    plot_training_history(history, "aco_lstm_training_history.png")
    ...
    model.save("final_aco_lstm_model.keras")
    joblib.dump(scaler, "aco_lstm_scaler.pkl")
    joblib.dump(selected_indices, "aco_lstm_selected_features.pkl")

    selected_feature_names = [feature_names[i] for i in selected_indices]
    with open("aco_lstm_selected_feature_names.txt", "w") as f:
    ...
    with open("aco_lstm_final_metrics.json", "w") as f:
        json.dump(final_metrics, f, indent=2)

    print("✓ Model saved as 'final_aco_lstm_model.keras'")
    print("✓ Scaler saved as 'aco_lstm_scaler.pkl'")
    print("✓ Selected features saved as 'aco_lstm_selected_features.pkl'")
    print("✓ Feature names saved as 'aco_lstm_selected_feature_names.txt'")
    print("✓ Metrics saved as 'aco_lstm_final_metrics.json'")
    print("✓ Training history plot saved as 'aco_lstm_training_history.png'")
