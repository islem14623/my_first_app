"""
GA + CNN Pipeline - Final PFE Version (UPDATED)
...
# Import GA functions (load_data only - GA algorithm skipped)
...
def main():
    ...
    # STEP 4: Load pre-computed GA feature selection results
    print("\n[STEP 4] Loading pre-computed GA feature selection results...")
    print("(Reusing FS results - no need to re-run GA algorithm)")
    ...
    print(f"✓ Loaded {len(selected_indices)} pre-selected features from GA")
    print(f"✓ Skipping GA algorithm - saves ~70 minutes!")
    ...
    plot_training_history(
        history,
        save_path="ga_cnn_training_history.png",
        model_name="GA + CNN"
    )
    ...
    print("✓ Training history plot saved as 'ga_cnn_training_history.png'")
